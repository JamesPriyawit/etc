...
public class ServerSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth)
            throws Exception {
        auth.authenticationProvider(new com.cupcodeteam.treasuristservice.configs.UserAuthenticationProvider());
    }
    ...
    public UserDetailsService userDetailsServiceBean() {
        return new com.cupcodeteam.treasuristservice.configs.JdbcUserDetails();
    }
